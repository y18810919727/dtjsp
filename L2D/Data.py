...
path = '{}/SavedNetwork/{}.pth'.format(dirname,
                                       str(N_JOBS_N) + '_' + str(N_MACHINES_N) + '_' + str(LOW) + '_' + str(HIGH))
...
dataLoaded = np.load(
    '{}/DataGen/test_sample/generatedData'.format(dirname) + str(N_JOBS_P) + '_' + str(N_MACHINES_P) + '_Seed' + str(
        SEED) + '.npy')
