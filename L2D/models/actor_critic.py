...
class ActorCritic(nn.Module):
    ...
    def forward(self,
        ...
        # print(h_pooled_repeated.size(), candidate_feature.size(), h_pooled_repeated,candidate_feature)
        ...
        # action_fea = candidate_feature.index_select(1, index).squeeze().tolist()
